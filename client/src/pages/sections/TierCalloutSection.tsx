        ...
        <CardContent className="relative flex min-h-[456px] flex-col p-8">
          ...
          <div className="relative mt-auto h-[280px] w-full">
            ...
            <Button
              type="button"
              variant="secondary"
              className="absolute left-[105px] bottom-[42px] h-auto w-fit rotate-[5deg] origin-bottom-left rounded-3xl border-0 bg-white px-5 py-3 text-center [font-family:'Poppins',Helvetica] text-base font-semibold leading-[22px] tracking-[0] text-[#cb7e1f] shadow-sm hover:bg-white/90"
            >
              Gamified Rewards
            </Button>
