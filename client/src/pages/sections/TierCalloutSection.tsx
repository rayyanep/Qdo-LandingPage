      ...
      <Card className="w-full max-w-[455px] rounded-3xl border-0 bg-[#eeeff4] shadow-none overflow-hidden">
        <CardContent className="relative flex min-h-[456px] flex-col p-8">
          ...
          <div className="relative mt-auto h-[280px] w-full">
            ...
            <div className="absolute right-[10px] top-[100px] flex h-[71px] w-[71px] rotate-[30deg] items-center justify-center rounded-full bg-white shadow-sm">
              <span className="[font-family:'Poppins',Helvetica] text-3xl font-light text-[#cb7e1f]">$</span>
            </div>
            ...
            <Button
              type="button"
              variant="secondary"
              className="absolute left-[120px] top-[140px] h-auto w-fit rotate-0 rounded-3xl border-0 bg-[#1a3d6c] px-5 py-3 text-center [font-family:'Poppins',Helvetica] text-base font-semibold leading-[22px] tracking-[0] text-white shadow-sm hover:bg-[#1a3d6c]/90"
            >
              Anti-Fraud Engine
            </Button>
            ...
            <Button
              type="button"
              variant="secondary"
              className="absolute left-[105px] bottom-[47px] h-auto w-fit rotate-[25deg] origin-bottom-left rounded-3xl border-0 bg-white px-5 py-3 text-center [font-family:'Poppins',Helvetica] text-base font-semibold leading-[22px] tracking-[0] text-[#cb7e1f] shadow-sm hover:bg-white/90"
            >
              Gamified Rewards
            </Button>
            ...
            <Button
              type="button"
              variant="secondary"
              className="absolute right-[-30px] top-[180px] h-auto w-fit rotate-[-12deg] rounded-3xl border-0 bg-[#659acd] px-5 py-3 text-center [font-family:'Poppins',Helvetica] text-base font-semibold leading-[22px] tracking-[0] text-white shadow-sm hover:bg-[#659acd]/90"
            >
              Real-Time Payouts
            </Button>
