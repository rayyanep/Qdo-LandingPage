...
export const LivePriceSection = (): JSX.Element => {
  return (
    <section className="relative w-full max-w-[455px]">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-[230px] -translate-x-1/2 -translate-y-1/2 aspect-square h-[640px] w-[640px] rounded-full border-[30px] border-solid border-[#f5f6fa] bg-transparent"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-[230px] -translate-x-1/2 -translate-y-1/2 aspect-square h-[555px] w-[555px] rounded-full border-[20px] border-solid border-white/60 bg-transparent"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-[230px] -translate-x-1/2 -translate-y-1/2 aspect-square h-[470px] w-[470px] rounded-full border-[50px] border-solid border-[#eef0f5] bg-transparent"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-[230px] -translate-x-1/2 -translate-y-1/2 aspect-square h-[260px] w-[260px] rounded-full border-[50px] border-solid border-white/70 bg-transparent"
      />
